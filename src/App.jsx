          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-400 font-sans my-2">
                ...
                Voluptatum eius facilis quae modi officiis eligendi optio, esse
                alias perferendis, consequatur distinctio illo architecto
                adipisci! Consectetur sapiente. Eligendi?
              </p>
              <LaunchButton />
            </div>
            <div className="flex w-full mt-60 flex-col items-center justify-around sm:flex-row">
              <div className="w-full max-w-md p-4 reveal-left js-observe">
                ...
                >
                  ...
                  <p className="text-[17px] md:text-2xl">
                    Simple and audited by industry-leading firms. Lorem ipsum
                    dolor sit amet.
                  </p>
                </div>
            ...
            <div className="w-full flex items-center flex-col gap-5 my-10">
              ...
              <div className="w-full flex flex-col items-center justify-center reveal-scale js-observe">
                ...
                >
                  ...
                  <p className="text-white">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Delectus rerum asperiores soluta veniam.
                  </p>
                </div>
                <div
                  className={`w-[70%] max-w-[300px] text-center ${
                ...
                >
                  ...
                  <p className="text-white">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Velit possimus sint quibusdam? Eum?
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-[95%] mx-auto flex flex-col lg:flex-row rounded-2xl overflow-hidden">
            <div className="w-full py-30 flex flex-col items-center gap-5 bg-[#e7d5fc] reveal-left js-observe">
              ...
              <p className="text-[#302659] text-[15px] w-[90%] text-center max-w-[450px]">
                Bring liquidity and users to your application by integrating
                Drop's liquid staking tokens. Get started with quick start
                guides, protocol documentation, and fully open-source code.
              </p>
              <button
                type="button"
